...
set(ALL_VIP_SUPPORTED_ARCH ${X86_64})
...
if(APPLE)
  ...
  list_intersect(DFSAN_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(VIP_SUPPORTED_ARCH
    ALL_VIP_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(VIP_SUPPORTED_ARCH ${ALL_VIP_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;dfsan;msan;hwasan;tsan;safestack;cfi;scudo;ubsan_minimal;gwp_asan;vip)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND VIP_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_VIP TRUE)
else()
  set(COMPILER_RT_HAS_VIP FALSE)
endif()
